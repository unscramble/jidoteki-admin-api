...
```
{
    "endpoints": ["settings", "certs", "license", "storage", "backup", "cluster"],
...
| 13. [Cluster](#cluster) | `POST /cluster` <br/> `GET /cluster` <br/> `GET /cluster/log` | Viewing and changing cluster settings. |
